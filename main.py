...
CATEGORIES = {
  ...
  'trash': { 'name': 'Мусор', 'emoji': '🗑', 'subs': ['Невывоз мусора', 'Переполненная урна', 'Свалка'], 'req_geo': True },
  'transport': { 'name': 'Транспорт', 'emoji': '🚌', 'subs': ['Нарушение графика', 'Хамство водителя', 'Грязный салон'], 'req_extra': True },
  'light': { 'name': 'Освещение', 'emoji': '💡', 'subs': ['Не горит фонарь', 'Мигает свет', 'Поврежден столб'] },
  'green': { 'name': 'Зеленые насаждения', 'emoji': '🌳', 'subs': ['Упавшее дерево', 'Необходим покос травы', 'Сухостой'] },
  'facades': { 'name': 'Фасады и крыши', 'emoji': '🏢', 'subs': ['Граффити', 'Осыпается фасад', 'Сосульки'] },
  'cleaning': { 'name': 'Уборка снега', 'emoji': '❄️', 'subs': ['Нечищеный двор', 'Гололед', 'Снежный вал'] },
  'kids': { 'name': 'Детские площадки', 'emoji': '🧸', 'subs': ['Сломаны качели', 'Мусор на площадке', 'Нет песка'] },
  'animals': { 'name': 'Животные', 'emoji': '🐕', 'subs': ['Стая бездомных собак', 'Агрессивное животное'], 'req_geo': True },
  'water': { 'name': 'Водоснабжение', 'emoji': '🚿', 'subs': ['Нет холодной воды', 'Нет горячей воды', 'Ржавая вода'] },
  'heating': { 'name': 'Отопление', 'emoji': '🌡', 'subs': ['Холодно в квартире', 'Слишком жарко', 'Течь батареи'] },
  'electricity': { 'name': 'Электричество', 'emoji': '🔌', 'subs': ['Отключение света', 'Искрит щиток'] },
  'sport': { 'name': 'Спортплощадки', 'emoji': '🏃', 'subs': ['Сломан инвентарь', 'Повреждено покрытие'] },
  'ads': { 'name': 'Реклама', 'emoji': '📢', 'subs': ['Незаконная вывеска', 'Расклейка листовок'] },
...
async def process_sub(callback: types.CallbackQuery, state: FSMContext):
    ...
    if CATEGORIES[data['cat_key']].get("req_extra"):
